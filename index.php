				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">PUNERI HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our PUNERI HOTEL</h3> 
						   <p class="about-para-w3ls">We provides Decorated room, proper air conditioned, Private balcony, WIFI COVERAGE, LARGE CAFE, SEA VIEW BALCONY, SUN RISE, MASTER BEDROOMS</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="images/a1.jpg" class="img-responsive" alt="Hair Salon">
										</div>
                                       <div class="w3ls-info-about">
										    <h4>You will love all the things  we offer!</h4>
											<p>Puneri Hotel provides the Rooms and Foods. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Ganesh Tekale</h4>
							<span>Manager</span>
							<p>Manager of the PUNERI HOTEL at Hadapsar Pune and pursuing the final year engineering from JSCOE college pune. .</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Uddhav Revgade</h4>
							<span>Manager</span>
							<p>Manager of ICICI Lombard at Samnbhaji nagar and have the good personality aslo richest person .</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Pushpa Revgade</h4>
							<span>Teacher</span>
							<p>Teacher at the Mahatma Gandhi college of Hotel and Managemnet at Sambhaji nagar  .</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Manisha Tekale</h4>
							<span>Voice Manager</span>
							<p>Voice Manager at PUNERI HOTEL and pursuing the B.tech in final year from MGM college Nagpur .</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Principal Architech(CTO Office,Icertis) PhD in Geometric Modeling Google Developer Expert (Machine Learning). </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Software Engineer at Microsoft and Ex-ShareChat and 2022 passout one of the my best friend. </p>
								<h5>Umang Agrawal</h5>
								<p>Hyderabad, India</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Software Developer Engineer at Amazon and best competetive programer and best friend from pune 2022 passout MIT college. </p>
								<h5>Vignesh Charan Raman</h5>
								<p>Maharashtra, India</p>
							</div>
							<div class="clearfix"> </div>
						</li>
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Software engineer at Microsoft 2022 passout from National institute of Technology Karnataka friend. </p>
								<h5>Shumbul Arifa</h5>
								<p>Delhi, India</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7774857400</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">ganeshtekale7400@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Satav nagar Hadapsar, Pune,  Maharashtra, India</p>
			...
			<iframe src="https://www.google.com/maps/search/jscoe+near+Hadapsar,+Pune,+Maharashtra/@18.4724813,73.9359077,394m/data=!3m2!1e3!4b1" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 PUNERI HOTEL . All Rights Reserved | Design by <a href="index.php">PUNERI HOTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
